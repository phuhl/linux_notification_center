...
For more styling options see [[More styling (#2, CLOSED)]].

For information on notification based scripting and modifications to
notifications see [[Notification based scripting (#3, #6, CLOSED)]].
